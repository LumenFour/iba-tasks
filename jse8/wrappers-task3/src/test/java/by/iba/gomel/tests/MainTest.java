...
public class MainTest {
	...
	public void testCalculation() {
		...
		String first = String.format("Given number:\n" + "Decimal:            1%n" + "Binary:             1%n"
				+ "Hex:                1%n" + "Octal:              1%n" + "Given number:\n" + "Decimal:           12%n"
				+ "Binary:          1100%n" + "Hex:                c%n" + "Octal:             14%n" + "Given number:\n"
				+ "Decimal:           31%n" + "Binary:         11111%n" + "Hex:               1f%n"
				+ "Octal:             37%n" + "Given number is not from 1 to 31.\n");
