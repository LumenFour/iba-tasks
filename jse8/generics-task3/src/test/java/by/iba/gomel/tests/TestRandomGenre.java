...
import by.iba.gomel.Crime;
import by.iba.gomel.Fantasy;
import by.iba.gomel.Mystery;
import by.iba.gomel.RandomGenre;
import by.iba.gomel.Romance;
import by.iba.gomel.ScienceFiction;
...
public class TestRandomGenre {
	...
	public void testRandom() {
		...
		// 1 more lines of code need to be covered by tests to reach the minimum
		// threshold of 50.0% lines coverage.
		Crime t = Crime.COZY;
