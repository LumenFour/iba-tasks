...
public class TestSaveLoadObjectFromFile {
	...
	public void testMenu() {
		...
		Pencil[] arrayOfPencils = { new Pencil(10, "Grey"), new Pencil(6, "Red"), new Pencil(9, "Blue") };
		...
		String resultInfo = "" + "Array of objects was serialized and saved in 'pencils.ser' file.\n"
