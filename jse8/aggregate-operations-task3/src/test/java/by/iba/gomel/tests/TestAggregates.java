...
import by.iba.gomel.Aggregates;
...
public class TestAggregates {
	...
	public void testAggregateOperation() {
		List<Book> list = Arrays.asList(new Book(750, "Don Quixote", 1605), new Book(560, "The Great Gatsby", 1925),
				new Book(80, "Crime and Punishment", 1866), new Book(670, "Alice's Adventures in Wonderland", 1862),
				new Book(840, "The Brothers Karamazov", 1880), new Book(40, "New book", 2005),
				new Book(40, "New book", 2005), new Book(70, "Short book", 2009), new Book(70, "Short book", 2009),
