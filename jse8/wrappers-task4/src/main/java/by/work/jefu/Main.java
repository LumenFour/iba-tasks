...
public final class Main {
	...
	public static void printPasswordStrength(String password) {
		final String output = "Password \"" + password + "\" is strong enough: " + verifyPasswordStrength(password)
				+ "\n\n";
	...
	public static boolean verifyPasswordStrength(String password) {
		...
		resultPoints = howManyDigits * cofficientForDigits + howManyUpperLetters * cofficientForUpperLetters
