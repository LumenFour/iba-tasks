...
public final class FileOperations {
	...
	/**
	 * Main function for the task. Finds int-number with long-offset in file.
	 * 
	...
	public static int getIntWithOffset(String filename) {
		long offset = -1;
		// Could be rewritten to Integer type with default value "null" (i.e. not found)
		// if needed.
		int intNumber = -1;
	 ...
	 * 
	 * How: reads array of bytes from 0 position in file. Converts them to readable
	 * String. Tries to get number from the beginning of the string (with regex) and
	 ...
	 * 
	 * How: reads array of bytes with offset from file. Converts them to readable
	 * String. Tries to get number from the beginning of the string (with regex) and
