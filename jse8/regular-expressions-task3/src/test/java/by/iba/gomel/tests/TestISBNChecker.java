...
import by.iba.gomel.ISBNChecker;
...
public class TestISBNChecker {
	...
	public void testBadNumber1() {
		...
		String first = String
				.format("Given ISBN number: \"979-10-306-46555-7\"%n[!] This ISBN number is incorrect.%n%n");
		Assert.assertEquals("test", first, this.log.getLog());
	}
	...
	public void testBadNumber2() {
		...
		String first = String
				.format("Given ISBN number: \"955-3-15-211444-2\"%n[!] This ISBN number is incorrect.%n%n");
		Assert.assertEquals("test", first, this.log.getLog());
	}
}
