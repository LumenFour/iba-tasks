...
import by.iba.gomel.QuestionAsker;
...
public class TestQuestionAsker {
	...
	public void testQuestionAsker() {
		List<String> listOfQuestions = Arrays.asList("How much is 2 plus 2?", "What is the longest river in the world?",
				"How much is 7 + 11?", "12-4 is..?", "How much is 65-41?", "What about 142312 + 14251?",
				"Logical operation 1 && 1 is equal to ..?",
				"Eiffel Tower is the most famous architectural landmark of ..?", "The main currency in USA? (plural)",
				"12:00 a.m. means noon or midnight?");

		List<String> listOfAnswers = Arrays.asList("4", "Amazon", "18", "8", "24", "156563", "1", "Paris", "dollars",
				"midnight");
		 ...
		 * 'fail' here means 5 sec timeout and/or wrong answer, i.e. in this case user
		 * can have 15 wrong answers and timeouts in total (till program won't stop).
		 *
		 * 2) When thread starts, it gets random question number.
		 *
		 * 3) Using semaphore only one thread enters the code area where it prints out
		 * the question.
		 *
		 * 4) Waits for user input for maximum 5 sec and close the program if it was
		 * right and finishes the current thread if it wasn't.
		 *
		 ...
		 */
		String resultInfo = "" + "Q5: How much is 65-41?\n" + "1\n" // user input
		 ...
		 */
		String resultInfoWithLogs = "" + "!Thread Thread-0 started. QN: 3\n" + "!Thread Thread-1 started. QN: 9\n"
	...
	public void testLogicWrongAnswer() {
		...
		String resultInfo = "" + "Q1: How much is 2 plus 2?" + "wrong answer!\n" + "!Thread main finished.\n";
	...
	public void testLogicRightAnswer() {
		...
		String resultInfo = "" + "Q1: How much is 2 plus 2?" + "right answer!";
		Assert.assertEquals("test", resultInfo, this.log.getLog());
	}
