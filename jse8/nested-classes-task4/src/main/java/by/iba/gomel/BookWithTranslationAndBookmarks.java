...
public final class BookWithTranslationAndBookmarks {
	...
	/**
	 * Method for translating the book with choosen Locale type (if implemented).
	 * Default language - English. Using anonymous classes for creating objects with
	 * needed methods.
	 * 
	...
	public void translate(Locale language) {
		Translatable translator = new Translatable() {
			...
			public void print() {
				String output = String.format(
						"-Pages of the book '%s' were translated to English " + "language (default).%n",
						getNameOfTheBook());
		...
		if (language.equals(Locale.GERMAN)) {
			translator = new Translatable() {
				...
				public void print() {
					final String output = String.format(
							"-Pages of the " + "book '%s' were translated to German " + "language.%n",
							getNameOfTheBook());
					BookWithTranslationAndBookmarks.LOGGER.info(output);
				}
			};
			...
			translator = new Translatable() {
				...
				public void print() {
					final String output = String.format(
							"-Pages of the book '%s' were translated to French" + " language.%n", getNameOfTheBook());
					BookWithTranslationAndBookmarks.LOGGER.info(output);
				}
			};
		}
	...
	public void addBookmark(String comment, int pageNumber) {
		...
		class Bookmark {
			...
			public void printBookmarkInfo() {
				final String output = String.format("This is a bookmark " + "for the page %d: %s%n", this.pageNumber,
						this.comment);
				BookWithTranslationAndBookmarks.LOGGER.info(output);
			}
		}
	 ...
	 * Static nested class.
	 * 
	 * "Must contain links to some Page". "Add method to navigate to some page".
	 */
	...
	/**
	 * Inner class of a page. SonarQube: "Make this a "static" inner class."
	 */
	static class Page {
