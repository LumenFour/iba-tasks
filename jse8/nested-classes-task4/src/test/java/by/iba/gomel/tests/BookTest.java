...
import by.iba.gomel.BookWithTranslationAndBookmarks;
import by.iba.gomel.BookWithTranslationAndBookmarks.Contents;
...
public class BookTest {
	...
	public void testBooksAndTranslation() {
		...
		BookWithTranslationAndBookmarks secondBook = new BookWithTranslationAndBookmarks("The Lord Of The Rings Part 2",
				860);
