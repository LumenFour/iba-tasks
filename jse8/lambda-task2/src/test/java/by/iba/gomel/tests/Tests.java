...
import by.iba.gomel.SortCollection;
...
public class Tests {
	...
	public void testAllSorts() {
		...
		String result = String.format("Basic collection:\n" + "\n" + "Alice in worderland  year: 1995  pages: 100  %n"
				+ "Fahrenheit 451       year: 2004  pages: 210  %n" + "Ender's Game         year: 1992  pages: 180  %n"
				+ "\n" + "Sorted by year descending:\n" + "\n" + "Fahrenheit 451       year: 2004  pages: 210  %n"
				+ "Alice in worderland  year: 1995  pages: 100  %n" + "Ender's Game         year: 1992  pages: 180  %n"
				+ "\n" + "Sorted by title ascending:\n" + "\n" + "Alice in worderland  year: 1995  pages: 100  %n"
