...
import by.iba.gomel.SimpleFileOperations;
...
public class TestSimpleFileOperations {
	...
	public void testFileCreateAndView() {
		...
		String resultInfo = "" + "-1-Create file-\n" + "Write file name: "
	...
	public void testFileDelete() {
		...
		// Some fields are empty because class was designed for user console input:
		String resultInfo = "" + "-2-Delete file-\n" + "Write file name: "
				+ "! The file 'newFile1.txt' doesn't exist.\n" + "\n" + "-2-Delete file-\n" + "Write file name: "
				+ "Are you sure you want to delete it? (y/n): " + "! file 'newFile.txt' was deleted!\n\n"
				+ "Exiting...";
		Assert.assertEquals("test", resultInfo, this.log.getLog());
	}
