...
public class Building {
	...
	private void printInfo2() {
		final String output = "# Crane thread " + Thread.currentThread().getName() + " occupies " + getNameOfBuilding()
				+ "\n";
		LOGGER.info(output);
	}
	...
	private void printInfo3(int iteration) {
		final String output = "#" + iteration + " Crane " + Thread.currentThread().getName() + " built floor #"
				+ floorBuilt + " in the " + getNameOfBuilding() + " in " + getSecondsToBuildAFloor() + " sec.\n";
		LOGGER.info(output);
	}
	 ...
	 * 
	 * @return true if building was built by crane. false if wasn't.
	 */
