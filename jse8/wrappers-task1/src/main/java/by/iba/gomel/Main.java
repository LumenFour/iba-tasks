...
public final class Main {
	 ...
	 * @throws ArgumentException A super class for more specific exceptions, like:
	 *                           "ZeroArgumentsException" and
	 *                           "OneArgumentException". These exceptions are not
	 *                           processed in this method, because of junit tests.
	 */
