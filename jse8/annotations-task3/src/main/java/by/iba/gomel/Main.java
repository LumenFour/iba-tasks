 ...
 * Main class.
 */
@Workaround(defectNumber = 5, author = "Dima", releaseNumber = 7)
public final class Main {
	 ...
	 */
	@Workaround(defectNumber = 3, author = "Vadim", releaseNumber = 4)
	 ...
	 */
	@Workaround(defectNumber = 99, author = "Denis", releaseNumber = 50)
	@Workaround(defectNumber = 50, author = "Olya", releaseNumber = 45)
