...
public final class GenericMethod {
	...
	/**
	 * Function to count the number of elements in a collection that satisfies some
	 * condition.
	 * 
	 * @param elements       Collection of elements.
	 * @param checkPredicate conditions which will be used in checks.
	 * @return amount of elements that satisfies some condition, or 0 if type T
	 *         doesn't satisfies the certain condition given by 'checkPredicate'.
	 */
