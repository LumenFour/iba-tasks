...
public class DataStructure {
	...
	/**
	 * Default constructor. Initializes {@link #arrayOfInts} of {@link #SIZE} with
	 * ints starting from 0 up to {@link #SIZE}.
	 */
	...
	/**
	 * Fills the {@link #arrayOfInts} with int values and prints out only values of
	 * even indices.
	 * 
	...
	// SonarLint error: "Iterator is a raw type. References to generic type
	...
	public final class EvenIterator implements DataStructureIterator {
		...
		public Integer next() {
			...
			// SonarLint error: "Add a "NoSuchElementException" for iteration beyond the end
			// of the collection."
